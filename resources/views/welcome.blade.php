...
<body>
    ...
    <header id="header" class="d-flex align-items-center">
        <div class="container d-flex align-items-center justify-content-between">
            ...
            <h1 class="logo"><a href="index.html">Lapor-OPS</a></h1>
                ...
                <div class="row">
                    ...
                    <div class="">
                        <div class="footer-info">
                            <h3>BAGIAN OPERASIONAL - POLRES MINAHASA</h3>
                            <p>
                                Jl. Sasaran, Wewelen, Tondano Utara <br>
                                Kabupaten Minahasa, Sulawesi Utara, Indonesia<br><br>
                                <strong>Phone:</strong> (0431) 321040<br>
